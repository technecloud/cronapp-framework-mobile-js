    ...
    app.directive('asDate', maskDirectiveAsDate)
        ...
        .directive('cronList', ['$compile', function($compile){
            ...
            var addCustomButton = function(column) {
                return '<ion-option-button class="button-dark" ng-click="listButtonClick($index, rowData, \''+window.stringToJs(column.execute)+'\')"><i class="icon ion-navigate"></i></ion-option-button>';
            }
            ...
            return {
                ...
                link: function(scope, element, attrs, ngModelCtrl) {
                    ...
                    try {
                        ...
                        scope.listButtonClick = function(idx, rowData, fn) {
